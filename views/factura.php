...
<?php include_once "footer/footer_views.php"; ?>
 ...
 <script>
                ...
                success: function(response) {
                    ...
                    $.each(response, function(index, factura) {
                        ...
                        let row = `<tr>
                            ...
                            <td><input id="payment-${datos.invoice_number}" class="btn btn-primary payment-btn" type="button" value="Payment"/> </td>
        ...
        // Obtén el invoice_number del botón que fue clickeado
