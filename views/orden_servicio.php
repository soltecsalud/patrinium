...
<head>
    ...
    <title>PatrimoniumAPP || Orden Servicio </title>
</head>
<body>
                ...
                <div class="col-md-10 offset-md-1">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Orden Servicio</h3>
                        ...
                        <div class="card-body">
                            <table id="facturaTable"class="table table-bordered">
                                ...
                                <tbody id="listar_servicios"></tbody>
                            </table>
                        </div>
                        <!-- /.card-body -->
                    </div>
...
<script>
  $(document).ready(function() {
    // Realizar la solicitud AJAX para obtener las facturas
    $.ajax({
        ...
        success: function(response) {
            console.log(response); // Puedes revisar la respuesta en la consola para depurar
            let tbody = $('#listar_servicios');
            ...
            $.each(response, function(index, factura) {
                ...
                let row = `<tr>
                   <td><input id="payment-${factura.id_solicitud}" class="btn btn-primary payment-btn" type="button" value="Generate Invoice" data-id-solicitud="${factura.id_solicitud}" data-id="${factura.id}"/></td>
            ...
            // Inicializa DataTables en la tabla si no está ya inicializada
            if (!$.fn.DataTable.isDataTable('#facturaTable')) {
...
$(document).ready(function() {
    // Manejo del evento click en .payment-btn
    $(document).on('click', '.payment-btn', function() {
        ...
        $.ajax({
            url: '../controller/facturaController.php', // Reemplaza con la ruta correcta a tu controlador
            type: 'POST',
            data: {
